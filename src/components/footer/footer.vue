	...
	<footer class="footer">
		...
		<nav class="footer__contacts">
			<a href="https://www.upwork.com/o/profiles/users/~015e7770f8d8102981/" target="_blank" class="footer__link">
				<span class="visually-hidden">Upwork</span>

				<svg class="footer__icon" width="40" height="40">
					<use xlink:href="@/assets/img/sprite.svg#upwork"></use>
				</svg>
			</a>

			<a href="https://www.linkedin.com/in/vadim-dyakonov-951913200" target="_blank" class="footer__link">
			...
			<a href="https://github.com/1lamer" target="_blank" class="footer__link">
